$(document).ready(function () {
    ...
    $c = 0;
            $("#sh_ps").on("click", function ()
            {
                if ($c == 0)
                {
                    $("#txt1").attr("type", "text");
                    $("#sh_ps i").removeClass("fa-eye").addClass("fa-eye-slash");

                    $c++;
                } else {
                    $("#txt1").attr("type", "password");
                    $("#sh_ps i").addClass("fa-eye").removeClass("fa-eye-slash");
                    $c = 0;
                }
             ...
             $c = 0;
            $("#sh_pss").on("click", function ()
            {
                if ($c == 0)
                {
                    $("#txt2").attr("type", "text");
                    $("#sh_pss i").removeClass("fa-eye").addClass("fa-eye-slash");

                    $c++;
                } else {
                    $("#txt2").attr("type", "password");
                    $("#sh_pss i").addClass("fa-eye").removeClass("fa-eye-slash");
                    $c = 0;
                }
             ...
             $c = 0;
            $("#sh_psss").on("click", function ()
            {
                if ($c == 0)
                {
                    $("#txt3").attr("type", "text");
                    $("#sh_psss i").removeClass("fa-eye").addClass("fa-eye-slash");

                    $c++;
                } else {
                    $("#txt3").attr("type", "password");
                    $("#sh_psss i").addClass("fa-eye").removeClass("fa-eye-slash");
                    $c = 0;
                }
