<!--MOBILE APP-->
	<section class="web-app com-padd com-padd-redu-top">
            ...
            <div class="row">
                <div class="col-md-6 web-app-img"> <img src="<?php echo base_url(); ?>assert/images/mobile.png" alt="" /> </div>
                <div class="col-md-6 web-app-con">
                    <h2>Looking for the Best Service Provider?</h2>
                    <ul>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Find nearby listings</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Easy service enquiry</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Listing reviews and ratings</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Manage your listing, enquiry and reviews</li>
                    </ul> <span>We Will Notify You Our Leatest Update.</span>
                        <ul>
                            <li>
                                <input type="email" id="email" name="email" class="form-control" placeholder="Enter Your E-Mail">
                            </li>    
                            <li>
                                <input style="margin-left: 547px;margin-top: -70px;" type="submit" onclick="subscriber();" value="Submit" class="btn btn-primary" /> 
                            </li>
                            <p style="color: red" id="err-msg"></p>
                        </ul>
                    
                    <a target="_new" href="https://www.apple.com/in/app-store/"><img src="<?php echo base_url(); ?>assert/images/apple.png" alt="" /></a>
                    <a target="_new" href="https://play.google.com/store"><img src="<?php echo base_url(); ?>assert/images/android.png" alt="" /></a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-5 col-md-3 foot-logo">
                                    ...
                                    <p class="hasimg" style="text-align: justify">Welcome to Cubics, your 'one shop' where you are assisted with day-to-day and exclusive planning and purchasing activities. We take pride in our iconic customer support number, 9429646472 and the fact that we own a strong</p><a href="<?php echo base_url(); ?>about-us" style="color: #ffffff" >Read More</a>
                                </div>
                                <div class="col-sm-5 col-md-3">
                                    ...
                                    <ul class="two-columns">
                                        ...
                                        <li> <a href="<?php echo base_url(); ?>faqs">FAQ'S</a> </li>
                                         <li> <a href="<?php echo base_url(); ?>terms-and-condtion">Terms&Condition</a> </li>
